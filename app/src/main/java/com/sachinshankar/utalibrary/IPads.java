...
public class IPads extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ipads);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        tv = (TextView) findViewById(R.id.description);
        tv.setText(Html.fromHtml(getString(R.string.ipad_detail)));
    ...
    private void doReserve() {
        ...
        if (! f.exists()) {
            AlertDialog.Builder dialog = new AlertDialog.Builder(IPads.this);
            ...
            dialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int id) {
                    Intent loginPage = new Intent(IPads.this, UserLogin.class);
            ...
            if(s=="") {
                ...
                new ReserveResource(this).execute(s,"3",loc);
